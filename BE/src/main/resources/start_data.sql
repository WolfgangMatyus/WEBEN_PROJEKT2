REPLACE INTO _user (id, active, address, email, firstname, lastname, password, payment, place, role, username, zip_code) VALUES
(1, True, 'zhaus','t@test.at', 'R2', 'Grod', '$2a$10$qbykEXhV3yQzZ7m2r4aFdO6uLojN.i06.dl.QMPxnxrxrAEFucdWe', 'kreditkarte','vienna', 'ROLE_USER', 'grod','1180'),
(2, True, 'woanders','rob@test.at', 'Rob', 'Spitz', '$2a$10$TDHubmli0uAh/ObBxygOQ.DfRo2Ae36ohWb9mX.P0Gfjbz9QOHNwq', 'bank','wien', 'ROLE_USER', 'rob','1180'),
(3, True, 'weitweg','wi21b055@technikum-wien.at', 'Wolf', 'Mat', '$2a$10$38rr3ldh/TPWLrXBQP/dx.OPflrF3oZnGd7IO/bJy3hy/W0BWdBJi', 'klarna','erlaa', 'ROLE_ADMIN', 'wolf','1230');
